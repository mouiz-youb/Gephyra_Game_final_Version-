...
function LoginForm() {
  ...
  return (
    <form onSubmit={handleSumit} className='w-full h-2/3 md:m-5 placeholder:font-bold placeholder:text-2xl  gap-5 md:h-2/3 md:w-1/2 flex  justify-evenly items-center flex-col  border-[#EEC181] border-[1.5px] rounded-[100px] bgForm p-5  '>
        <InputComponent
        value={email}
